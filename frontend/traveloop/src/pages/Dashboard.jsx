...
export default function Dashboard() {
  ...
  const fetchTrips = async () => {
    try {
      const response = await getUserTrips(user.uid);
        ...
        >
          ...
          <div className="relative z-10 p-10">
            ...
            <button
              ...
              className="mt-8 bg-rose-600 hover:bg-rose-700 px-6 py-3 rounded-xl text-white font-semibold">
              Create Trip
            </button>
          </div>
        </div>

        <h2 className="text-3xl text-white font-bold mt-12 mb-8">My Trips</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {trips.map((trip) => (
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-2xl text-white font-bold">{trip.title}</h3>
